...
bool UbloxATCellularInterfaceN2xx::set_power_saving_mode(int periodic_time, int active_time)
{
...
void UbloxATCellularInterfaceN2xx::uint_to_binary_str(uint32_t num, char* str, int str_size, int bit_cnt)
{
